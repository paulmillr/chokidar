...
const setFsWatchListener = (path, fullPath, options, handlers) => {
  ...
  if (cont) {
    addAndConvert(cont, 'listeners', listener);
    addAndConvert(cont, 'errHandlers', errHandler);
    addAndConvert(cont, 'rawEmitters', rawEmitter);
  } else {
    watcher = createFsWatchInstance(
      path,
      options,
  ...
  return () => {
    delFromSet(cont, 'listeners', listener);
    delFromSet(cont, 'errHandlers', errHandler);
    delFromSet(cont, 'rawEmitters', rawEmitter);
