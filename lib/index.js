...
FSWatcher.prototype._removeFromWatchedDir = function(fileToRemove, directory) {
  var watchedFiles = this._getWatchedDir(directory);
  watchedFiles.forEach(function(file, index) {
...
FSWatcher.prototype._addToWatchedDir = function(fileToAdd, directory) {
  var watchedFiles = this._getWatchedDir(directory);
  watchedFiles.push(fileToAdd);
};
    ...
    fs.readdir(directory, function(error, current) {
      ...
      previous
        ...
        .forEach(function(file, index) {
          _this._removeFromWatchedDir(file, directory);
      ...
      current
        ...
        .forEach(function(file) {
          _this._addToWatchedDir(file, directory);
