...
class FSWatcher extends EventEmitter {
  ...
  _throttle(Action, Path, Timeout){
    ...
    if (Path in this._throttled[Action]) return false;
    var
      Throttled = this._throttled[Action],
      ClearThrottle = H.ClearThrottle.bind(null, Throttled, TimeoutObject, Path),
      TimeoutObject = setTimeout(ClearThrottle, Timeout);
    Throttled[Path] = {timeoutObject: TimeoutObject, clear: ClearThrottle};
