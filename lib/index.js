...
FSWatcher.prototype._getWatchHelpers = function(path) {
  ...
  var getDirParts = function(path) {
    ...
    var parts = sysPath.relative('.', path).split(/[\/\\]/);
    return parts;
  }
  ...
  var filterDir = function(entry) {
    ...
    if (hasGlob) {
      ...
      var unmatchedGlob = dirParts.length > entryParts.length ||
        !dirParts.every(function(part, i) {
          return anymatch(part, entryParts[i]);
        });
    }
